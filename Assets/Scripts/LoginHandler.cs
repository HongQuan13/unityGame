...
//   Task HandleCreateUserAsync(Task<Firebase.Auth.AuthResult> authTask,
...
//       .ContinueWith(task => HandleSigninResult(task));
//   }

//   void HandleSigninResult(Task<Firebase.Auth.AuthResult> authTask) {
